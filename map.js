...
var sanfrancisco = L.marker([2730, 6380],{icon: pin}).addTo(map);
sanfrancisco.bindPopup("<h1>1912</h1><br><em>Escuela Normal Nacional</em><br>San Francisco");

var alberdi = L.marker([2730, 3380],{icon: pin}).addTo(map);
